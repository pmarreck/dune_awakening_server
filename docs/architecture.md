...
- 2026-09-24 23:50 EDT: launchers for every piece exist: `libexec/dune-director`, `libexec/dune-gateway`, `libexec/dune-server` and `bin/dune-world` (up, down, status in dependency order). Notes:
